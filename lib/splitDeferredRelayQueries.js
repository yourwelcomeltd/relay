...
function createRefQuery(descriptor, context) {
  ...
  !(node instanceof require('./RelayQuery').Field || node instanceof require('./RelayQuery').Fragment) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'splitDeferredRelayQueries(): Ref query requires a field or fragment.') : require('fbjs/lib/invariant')(false) : void 0;
