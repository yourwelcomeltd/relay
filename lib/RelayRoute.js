...
var RelayRoute = function (_RelayQueryConfig) {
  ...
  function RelayRoute(initialVariables, uri) {
    ...
    !routeName ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, '%s: Subclasses of RelayRoute must define a `routeName`.', constructor.name || '<<anonymous>>') : require('fbjs/lib/invariant')(false) : void 0;
