    ...
    return {
      visitor: {
        ...
        TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
          ...
          !(path.node.quasi.quasis.length === 1) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Substitutions are not allowed in ' + 'graphql fragments. Included fragments should be referenced ' + 'as `...MyModule_propName`.') : require('fbjs/lib/invariant')(false) : void 0;

          var text = path.node.quasi.quasis[0].value.raw;
          var ast = require('./graphql').parse(text);

          !(ast.definitions.length === 1) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Expected exactly one definition (fragment, ' + 'mutation, query, or subscription) per graphql tag.') : require('fbjs/lib/invariant')(false) : void 0;
          ...
          var visitors = {
            Directive: function Directive(node) {
              switch (node.name.value) {
                case 'argumentDefinitions':
                  !!argumentDefinitions ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Expected only one ' + '@argumentDefinitions directive') : require('fbjs/lib/invariant')(false) : void 0;
            ...
            FragmentSpread: function FragmentSpread(node) {
              ...
              if (directives.length === 0) {
                ...
                !(directives.length === 1 && directive.name.value === 'arguments') ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Unsupported directive `%s` on fragment ' + 'spread `...%s`; only the @arguments directive is supported ' + 'on fragment spreads when using the graphql tag.', directive.name.value, fragmentName) : require('fbjs/lib/invariant')(false) : void 0;
          ...
          if (definitionKind === 'FragmentDefinition') {
            ...
            !keyName ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: graphql`...` fragment definitions may ' + 'only appear as a property of an object literal inside a ' + 'createContainer() call.') : require('fbjs/lib/invariant')(false) : void 0;

            var fragmentNameParts = definitionName.match(/(^\w+)_(\w+)$/);
            !fragmentNameParts ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Fragment names in graphql tags have to ' + 'be named as ModuleName_propName. Got `%s`', definitionName) : require('fbjs/lib/invariant')(false) : void 0;
            !(fragmentNameParts[1] === state.file.opts.documentName) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Fragment names in graphql tags have to ' + 'be named as ModuleName_propName. Got `%s`, but expected `%s`', definitionName, state.file.opts.documentName + '_' + keyName) : require('fbjs/lib/invariant')(false) : void 0;
            !(fragmentNameParts[2] === keyName) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Fragment names in graphql tags have to ' + 'be named as ModuleName_propName. Got `%s`, but the prop is ' + 'named `%s`', definitionName, keyName) : require('fbjs/lib/invariant')(false) : void 0;
            ...
            !(operationNameParts && definitionName.indexOf(state.file.opts.documentName) === 0) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Operation names in graphql tags have ' + 'to be prefixed with `ModuleName` and end in either "Mutation", ' + '"Query", or "Subscription". Got `%s` in module `%s`.', definitionName, state.file.opts.documentName) : require('fbjs/lib/invariant')(false) : void 0;
            ...
            !false ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Expected a fragment, mutation, query, or ' + 'subscription, got `%s`.', definitionKind) : require('fbjs/lib/invariant')(false) : void 0;
          }
...
function parseValue(t, value) {
  switch (value.kind) {
    ...
    default:
      !false ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Unsupported literal type `%s`.', value.kind) : require('fbjs/lib/invariant')(false) : void 0;
  }
}
...
function splitRootFields(t, root) {
  var properties = root.selectionSet.selections.map(function (selection) {
    !(selection.kind === 'Field') ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Expected the root fields of operation `%s` to be ' + 'fields, got `%s`.', root.name.value, selection.kind) : require('fbjs/lib/invariant')(false) : void 0;
...
function createSubstitutionsForFragmentSpreads(t, fragments) {
  return (0, _keys2['default'])(fragments).map(function (varName) {
    ...
    !match ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'BabelPluginGraphQL: Fragments should be named ' + '`ModuleName_fragmentName`, got `%s`.', fragment.name) : require('fbjs/lib/invariant')(false) : void 0;
    var module = match[1];
