...
var PendingGraphQLTransaction = function () {
  ...
  PendingGraphQLTransaction.prototype.getOptimisticResponse = function getOptimisticResponse() {
    return (0, _extends5['default'])({}, this._optimisticResponse, (0, _defineProperty3['default'])({}, require('./RelayConnectionInterface').CLIENT_MUTATION_ID, this.id));
  };
  ...
  PendingGraphQLTransaction.prototype._getVariables = function _getVariables() {
    ...
    if (!input) {
      !false ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayGraphQLMutation: Required `input` variable is missing ' + '(supplied variables were: [%s]).', (0, _keys2['default'])(this._variables).join(', ')) : require('fbjs/lib/invariant')(false) : void 0;
    }
    return (0, _extends5['default'])({}, this._variables, {
      ...
      input: (0, _extends5['default'])({}, input, (0, _defineProperty3['default'])({}, require('./RelayConnectionInterface').CLIENT_MUTATION_ID, this.id))
    });
  };
