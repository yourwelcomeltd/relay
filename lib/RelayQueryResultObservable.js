...
var RelayQueryResultObservable = function () {
  ...
  RelayQueryResultObservable.prototype.subscribe = function subscribe(callbacks) {
    ...
    var subscription = {
      dispose: function dispose() {
        !_this._subscriptionCallbacks[subscriptionIndex] ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayQueryResultObservable: Subscriptions may only be disposed once.') : require('fbjs/lib/invariant')(false) : void 0;
  ...
  RelayQueryResultObservable.prototype._observe = function _observe() {
    ...
    !!this._fragmentResolver ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayQueryResultObservable: Initialized twice.') : require('fbjs/lib/invariant')(false) : void 0;
  ...
  RelayQueryResultObservable.prototype._resolveData = function _resolveData(fragmentResolver) {
    ...
    !!Array.isArray(data) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayQueryResultObservable: Plural fragments are not supported.') : require('fbjs/lib/invariant')(false) : void 0;
    this._data = data;
  };
