...
if (process.env.NODE_ENV !== 'production') {
  process.env.NODE_ENV !== 'production' ? require('fbjs/lib/warning')(typeof _promise2['default'] === 'function' && Array.prototype.find, 'Relay relies on polyfills for ES6 features in older browsers. ' + 'Babel provides a good one: https://babeljs.io/docs/usage/polyfill/') : void 0;
}
