  ...
  function assertValid(properties) {
    ...
    (0, _keys2['default'])(config).forEach(function (property) {
      ...
      if (!properties.hasOwnProperty(property)) {
        ...
        if (suggestion) {
          !false ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, '%s; did you mean `%s`?', _message, suggestion) : require('fbjs/lib/invariant')(false) : void 0;
        } else {
          /* eslint-disable fb-www/sprintf-like-args-uniqueness */
          !false ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, '%s.', _message) : require('fbjs/lib/invariant')(false) : void 0;
